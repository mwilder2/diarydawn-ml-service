...
def return_ocean_predictions(text, model_paths):
    ...
    for model_path in model_paths:
        try:
            ...
            continue  # Continue with the next model path instead of stopping

    # Check if any models were successfully loaded and predictions made
